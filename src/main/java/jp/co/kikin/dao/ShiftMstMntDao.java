...
public class ShiftMstMntDao extends Dao {
    ...
    public List<ShiftMstMntDto> getAllList() throws SQLException{
        ...
        try {
            ...
            while (rs.next()) {
                ...
                shiftMstMntDto.setSymbol(CommonUtils.changeNullToBlank(rs.getString(M_shift.SYMBOL.getName()))); // シンボル　shiftNameを参照していたものを修正
    ...
    public void deleteShiftMst(String shiftId) throws SQLException{
        ...
        try {
            ...
            strSql.append("m_shift ");
            strSql.append("WHERE ");
            strSql.append("shift_id = ?"); //WHERE句以降なかったため追記　長谷川
