...
public class BaseShiftDao extends Dao {
    ...
    public Map<String, BaseShiftDto> getBaseShiftDataList() throws SQLException {
        ...
        try {
            ...
            strSql.append("   emp.employee_id     "); // order byの基準を社員マスタに変更　古賀
            // strSql.append("   limit 3     "); limit 3になっていたためコメントアウト　古賀
            ...
            while (rs.next()) {
                ...
                baseShiftDto.setShiftIdOnMonday   (rs.getString(M_base_shift.MONDAY.getName()));            // 月曜日シフトＩＤが抜けていたので追加　古賀
    ...
    public void updateWorkRecord(BaseShiftDto baseShiftDto, String loginEmployeeId) throws SQLException{
        ...
        try {
            ...
            strSql.append("     ,update_datetime       = current_timestamp() "); //CURRENT_DATE をtimestampに変更　古賀
            strSql.append(" WHERE ");
            strSql.append("     employee_id   = ? ");
